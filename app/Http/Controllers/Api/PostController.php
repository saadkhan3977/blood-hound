...
class PostController extends BaseController
{
    ...
    public function index(Request $request)
    {
        try
        {
            ...
            $userid = Auth::id();
            $post = Post::withCount('like','comment','comment.replies')->with(['images','comments.user','comments.replies','comments.replies.user','locations','tags','my_like'=> function($query) use ($userid) {
